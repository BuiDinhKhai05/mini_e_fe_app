...
const String _kScreenIllustrationAsset = 'assets/images/mochi/otp_phone.png';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _MochiAuthScaffold(
        title: 'Đổi mật khẩu',
        subtitle: 'Nhập OTP và tạo mật khẩu mới cho tài khoản 💗',
        ...
        child: Column(
          ...
          children: [
            _InfoBox(
              ...
              title: 'Email: $email',
              subtitle: 'Kiểm tra OTP trong Gmail',
            ),
            ...
            _MochiPrimaryButton(
              ...
              onPressed: () {
                ...
                if (!passwordRegex.hasMatch(password)) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Password phải có chữ hoa, chữ thường, số và ký tự đặc biệt')),
                  );
                  return;
                }
